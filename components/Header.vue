	...
	<header class="header flex items-center justify-center h-24 sticky top-0 z-10">
		<section class="h-full flex items-center justify-between w-full max-w-screen-xl p-3">
					...
					<button type="button"
						...
						<svg class="h-9 w-9" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
							...
							<path stroke-linecap="round" stroke-linejoin="round"
								d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" style="stroke: white;" />
						</svg>
					</button>
				</div>
			</nav>
			...
			<div v-show="isOpen" class="lg:hidden" role="dialog" aria-modal="true">
				...
				<div
					class="h-full fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
					<div class="flex items-center justify-between">
						<button type="button" class="ml-auto -m-2.5 rounded-md p-2.5 text-gray-700"
